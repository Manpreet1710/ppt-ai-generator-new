...
export const PresentationGrid = ({
 ...
 const CreateNewCard = () => (
  <div
    ...
    className="flex flex-col gap-5 min-h-[220px] cursor-pointer group border border-gray-200 hover:border-primary/60 bg-white hover:bg-gray-50 rounded-2xl items-center justify-center shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300"
  >
    <div className="rounded-full bg-gray-100 group-hover:bg-primary/10 p-5 transition-all duration-300">
      <PlusIcon className="w-9 h-9 text-gray-500 group-hover:text-primary transition-all duration-300" />
    </div>
