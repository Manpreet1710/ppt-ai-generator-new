  ...
  return (
    <Wrapper className="pb-10 lg:max-w-[70%] xl:max-w-[65%]">
      ...
      <Button
        ...
        className="w-full rounded-[32px] flex items-center justify-center py-6 bg-[#4701ff] text-white font-instrument_sans font-semibold text-xl hover:bg-[#4701ff]/80 transition-colors duration-300"
