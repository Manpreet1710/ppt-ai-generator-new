              ...
              <ToolTip content="Add new slide below">
                {!isStreaming && !loading && (
                  <div
                    ...
                    className="  bg-white shadow-md w-[80px] py-2 border hover:border-[#4701ff] duration-300  flex items-center justify-center rounded-lg cursor-pointer mx-auto"
                  >
              ...
              <Popover>
                <PopoverTrigger>
                  <ToolTip content="Update slide using prompt">
                    <div
                      className={`p-2 group-hover:scale-105 rounded-lg bg-[#4701ff] hover:shadow-md transition-all duration-300 cursor-pointer shadow-md `}
                    >
