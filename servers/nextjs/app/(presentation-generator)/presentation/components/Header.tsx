      ...
      <div style={{
        ...
        <Popover open={open} onOpenChange={setOpen} >
          <PopoverTrigger asChild>
            <Button className={`border py-5 bg-[#4701ff] font-bold rounded-[32px] transition-all duration-500 hover:border hover:bg-[#5146E5] hover:text-white w-full `}>
  ...
  return (
    <>
      ...
      <div
        ...
        className="bg-[#fff] w-full shadow-lg sticky top-0 ">
