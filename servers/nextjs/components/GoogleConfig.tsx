                ...
                >
                  <div className="flex gap-3 items-center">
                    <span className="text-sm font-medium text-gray-900">
                      {googleModel
                        ? availableModels.find(model => model.name === googleModel)?.display_name || googleModel
                        : "Select a model"}
                    </span>
                  </div>
                      ...
                      {availableModels.map((model) => (
                        <CommandItem
                          ...
                          onSelect={(currentValue) => {
                            onInputChange(
                              currentValue === googleModel ? "" : currentValue,
                              "google_model"
                            );
                        ...
                        >
                          <Check
                            className={cn(
                              "mr-2 h-4 w-4",
                              googleModel === model.name ? "opacity-100" : "opacity-0"
                            )}
                          />
                          {model.display_name}
                        </CommandItem>
