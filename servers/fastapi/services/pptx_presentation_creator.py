...
class PptxPresentationCreator:
    ...
    async def fetch_network_assets(self):
        ...
        print("--- Starting Network Asset Fetch ---")
        ...
        if image_urls:
            print(f"Found {len(image_urls)} network images to download.")
            ...
            for each_shape, each_image_path in zip(
                ...
                if each_image_path:
                    print(f"Updating shape with new image path: {each_image_path}")
                    each_shape.picture.path = each_image_path
                    each_shape.picture.is_network = False
                else:
                    print(f"Warning: Failed to download image for shape. URL: {each_shape.picture.path}")
        
        print("--- Finished Network Asset Fetch ---")
